...
- [ ] Add distribution micro-playbook section directly on homepage/footer link to `ops/outreach-distribution-checklist.md`
- [ ] Re-check SSL readiness and update `ops/ssl-readiness-2026-02-17.md` with latest status/evidence
