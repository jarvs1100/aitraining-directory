...
- [ ] Create distribution asset pack for the remediation-workflow comparison route (LinkedIn post, X thread hook, newsletter blurb with canonical URL).
- [ ] Add i18n parity stubs for the new remediation route on `/de` and `/es` localized hubs with canonical compare linkage.
- [ ] Mobile UX polish pass: improve compare-page matrix card title spacing for dense criteria labels on 360px screens.
